<?php /* Smarty version Smarty-3.1.6, created on 2015-12-28 10:27:55
         compiled from "../DataSource/Tpl\Enroll\index.html" */ ?>
<?php /*%%SmartyHeaderCode:29826562cf98aa4ba56-83233498%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '29826562cf98aa4ba56-83233498',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_562cf98aace50',
  'variables' => 
  array (
    'error' => 0,
    'countries' => 0,
...
<?php if ($_valid && !is_callable('content_562cf98aace50')) {function content_562cf98aace50($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('Comon/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

<link rel="stylesheet" type="text/css" href="/static/css/Enroll.css">
<script src="/static/js/function.js"></script>
<script src="/static/js/enroll.js"></script>
<script type="text/javascript">
	showMsg("提示","报名已结束！","回到首页","查看报名",function(){
 		window.location.href = "/";
 	},function(){
 		window.location.href = "/EnrollInfo/index";
 	});
</script>
...
"><?php echo $_smarty_tpl->tpl_vars['i']->value['title'];?>
				...
				<li class="txt">赛服尺码</li>
				<li class="line">
					<div class="label fl"><label><input type="radio" value="S" name="zbchima" >&nbsp;S</label></div>
					<div class="label fl"><label><input type="radio" value="M" name="zbchima" >&nbsp;M</label></div>
					<div class="label fl"><label><input type="radio" value="L" name="zbchima" >&nbsp;L</label></div>
					<div class="label fl"><label><input type="radio" value="XL" name="zbchima" >&nbsp;XL</label></div>
					<div class="label fl"><label><input type="radio" value="XXL" name="zbchima" >&nbsp;XXL</label></div>
					<div class="label fl"><label><input type="radio" value="XXXL" name="zbchima" >&nbsp;XXXL</label></div>
					<div class="clearfix"></div>
				</li>
			</ul>
			<div class="line"></div>
