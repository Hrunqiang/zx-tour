...
document.getElementById("sharepage").innerHTML = '<div class="logo"><img src="./images/logo_1.png" alt=""></div><div class="qrcode"><img class="qrcode_img" src="./images/qrcode.jpg" alt=""><p>长按二维码识别关注</p></div><div class="p5_text hu_info"><img src="./images/p5_3.png" /></div>';
//  }
}