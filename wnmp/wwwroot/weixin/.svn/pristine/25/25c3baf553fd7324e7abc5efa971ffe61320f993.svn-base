...
class MailModel{
	protected $mail_config = array(
		...
		"Username"   =>"notice@zx42195.com",
		"Password"   =>"Zhixingheyi1",
		"AddReplyTomail"=> "notice@zx42195.com",//回复地址
		"AddReplyToname" =>"知行合逸客服",
		"From"=> "notice@zx42195.com",
		"FromName"   =>"知行合逸客服"
		);
	...
	public function send($email,$title,$content){
		...
		try {
			...
			@mwtlog("mail_send_data","mail:".$email."\t ".Date("Y-m-d H:i:s")."title".$title,true);
			return false;
		}	
		return true;
	}
