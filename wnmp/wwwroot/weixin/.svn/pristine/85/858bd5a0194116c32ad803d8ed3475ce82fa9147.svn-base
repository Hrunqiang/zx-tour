//依赖于jquery
var WxReady = false,sharetitle = "东京马拉松成绩查询",sharedes = "知行技术团队特别为参加东马的小伙伴们提供了一个更加便捷的成绩查询方式，三步拿到成绩",shareurl= "http://weixin.zx-tour.com/dmcx/share.html",shareimg="http://weixin.zx-tour.com/dmcx/images/head.jpg";
//初始化
wx.init = function(){
