<?php /* Smarty version Smarty-3.1.6, created on 2016-11-22 10:41:39
         compiled from "../DataSource/Tpl\Index\index.html" */ ?>
<?php /*%%SmartyHeaderCode:624858131577d93405-26488014%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '624858131577d93405-26488014',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_58131577f1034',
  'variables' => 
  array (
    'sexy' => 0,
    'hotwords' => 0,
...
<?php if ($_valid && !is_callable('content_58131577f1034')) {function content_58131577f1034($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('Comon/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
#search_cancel{color: #04BE02;font-size: 1.142857142857143rem;line-height: 2rem;}
...
.hot_tj .hot_color{color: #04BE02;}
.hot_color .hot_color_1{position: relative;}
.hot_color .hot_color_1 span{height: 0.5714285714285714rem;width: 0.5714285714285714rem;background: #04BE02;border-radius: 5px; position: absolute;right: -0.5714285714285714rem;top: -0.1428571428571429rem;}
    ...
    <div class="index_section" id="index_page">
        ...
        <div class="footer  weui_msg">
            <div class="weui_text_area">
                <p class="weui_msg_desc"><a href="tel:4000-842-195">联系我们</a><span id="j_z_f"></span><a href="/user/feedback">意见反馈</a><span id="j_z_f"></span><a href="/gw">关于我们</a></p>
...
sharetitle = "知行合逸";
sharedes = "全球跑步赛事，一站直达";
timelinetitle = "知行合逸 - 全球跑步赛事，一站直达";
wxbind();
					...
					$('.hot_matchs').append(htm_str);
						...
						success:function(obj){
							if(obj.error==0){
								...
								var Time=Obj[key].m_GameTime.substring(0,10);
								var types=Obj[key].m_Mtypes.replace(/\|/g,'<span></span>');
								var str='<a href="/Matchinfo?m_id='+Obj[key].id+'&platform=zx-tour" class="weui_media_box weui_media_appmsg"><div class="weui_media_hd"><img class="weui_media_appmsg_thumb" src='+Obj[key].m_img+' alt=""></div><div class="weui_media_bd"><h4 class="weui_media_title flex"><span class="S_overhiden">'+Obj[key].m_name+'</span>'+minge+'</h4><p class="weui_media_desc weui_media_desc_1 line2 weui_media_title_position">'+Obj[key].m_des+'</p><p class="weui_media_desc weui_media_desc_padding">'+Time+'  '+types+'</p></div></a>';
