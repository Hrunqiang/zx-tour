<?php /* Smarty version Smarty-3.1.6, created on 2016-11-21 16:42:27
         compiled from "../DataSource/Tpl\Enroll\index.html" */ ?>
<?php /*%%SmartyHeaderCode:4716581bffd4e98ae4-49076610%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '4716581bffd4e98ae4-49076610',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_581bffd54691b',
  'variables' => 
  array (
    'course' => 0,
    'meal' => 0,
...
<?php if ($_valid && !is_callable('content_581bffd54691b')) {function content_581bffd54691b($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('Comon/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<style type="text/css">
	...
	.weui_btn_warn{background: #04BE02;/*border-radius: 0.2857142857142857rem;font-size: 1.142857142857143rem;line-height: 2.428571428571429rem;*/}
	...
	.btn{position: fixed;bottom: 0px;padding: 0.6428571428571429rem 1.142857142857143rem;display: -webkit-box; display: flex;display: -webkit-flex;display: -ms-flexbox;width: 100%;box-sizing: border-box;background: #FFFFFF;border-top: 1px solid #D9D9D9;max-width: 768px;}
	...
	.btn_ptfu{line-height: 2.5rem;background: #04BE02;}
	...
	.pay_price{font-size: 1.571428571428571rem!important;color: #000000;}
	...
	.active_bz_back input{background: #04BE02;}
	...
	.fuwu_header{position: absolute;bottom: 0;background: #FFFFFF;width: 100%;min-height: 16.5rem;padding-bottom: 4.285714285714286rem;}
	...
	.fuwu_price{color: #000000;font-size: 1.214285714285714rem;}
	._gprice{color: #000000;font-size: 1.214285714285714rem;}
		...
		<div class="weui_cell weui_cell_select weui_select_after select_tc" style="background: #FFFFFF;font-size: 1rem!important;">
         ...
         <div class="weui_cell weui_cell_select weui_select_after zubie" style="background: #FFFFFF;font-size: 1rem!important;">
          ...
          <div class="weui_cell weui_cell_select weui_select_after type_tc_price" style="background: #FFFFFF;font-size: 1rem!important;">
            <div class="weui_cell_bd weui_cell_primary" style="text-align: right;padding: 0.6428571428571429rem 0;color: #848484;padding-right: 0.8571428571428571rem;">根据您选择的套餐和组别，您的套餐费用<span style="color: #000000;font-size: 12px;">￥</span><span class="_gprice"></span></div>
         </div>
   	</div>
   	...
   	<div class="enroll_lists" id="mealBox">
		...
		<div class="weui_cells weui_cells_access">
            ...
            <div class="weui_cell weui_cell_select weui_select_after other_sev">
            	<div class="weui_cell_primary" style="text-align: right;font-size: 0.9285714285714286rem;padding: 0.7142857142857143rem 0;color: #848484;padding-right: 12px;font-size: 1rem;">您的其他服务费用为<span style="color: #000000;font-size: 12px;">￥</span><span class="fuwu_price"></span></div>
         	</div>
        </div>
	</div>
    <?php }?>
...
" name="remarks">
	...
	<div class="btn" style="">
		...
		<div style="color: #282828;line-height: 1.571428571428571rem;font-size: 0.9285714285714286rem;">实付:<span style="color: #000000;"> ￥</span><span class="pay_price"></span></div>	
        <input style="width: auto;float: right;border-radius: 0.2857142857142857rem;" type="submit" class="weui_btn weui_btn_primary" value="提交订单" />
    </div>
    <!--//////-->
    <div class="fuwu_mask">
...
$('.weui_check_label').bind('touchend',function (e) {
...
$('.fuwu_name').html($('.fuwu_g_name').length+'项');
