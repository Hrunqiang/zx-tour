<?php /* Smarty version Smarty-3.1.6, created on 2016-11-16 19:05:18
         compiled from "../DataSource/Tpl\Search\index.html" */ ?>
<?php /*%%SmartyHeaderCode:1186358291c430ee9b1-57053815%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1186358291c430ee9b1-57053815',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_58291c43398e4',
  'variables' => 
  array (
    'hotcitys' => 0,
    'list' => 0,
...
<?php if ($_valid && !is_callable('content_58291c43398e4')) {function content_58291c43398e4($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('Comon/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
$(function () {
	...
	var winH=$(window).height();
		...
		if(aa<0.3&&scroll_lenth>=10*(_scroll_page+1)){
			if(stop==true){
				stop=false;
				_scroll_page++;
...
//								sourceHTML = '<div><span class="orange">￥</span><span class="orange_price">'+infolist[m_i]['g_currprice']+'</span><span class="orange">起/人</span><del class="orange_yj">'+infolist[m_i]['g_currprice']+'</del> <span class="orange_text">赛事报名</span></div><div style="overflow: hidden;"><span class="attend_num">已报'+stock+'</span></div>';
								sourceHTML = '<div><span class="orange">￥</span><span class="orange_price">'+infolist[m_i]['g_currprice']+'</span><span class="orange">起/人</span><del class="orange_yj">'+infolist[m_i]['g_currprice']+'</del> <span class="orange_text">赛事报名</span></div><div style="overflow: hidden;"></div>';
...
//								mealHTML = '<div><span class="orange">￥</span><span class="orange_price">'+infolist[m_i]['g_currprice']+'</span><span class="orange">起/人</span><del class="orange_yj">'+infolist[m_i]['g_currprice']+'</del> <span class="orange_text">赛事报名</span></div><div style="overflow: hidden;"></div>';
								mealHTML = '<div><span class="orange">￥</span><span class="orange_price">'+infolist[m_i]['g_currprice']+'</span><span class="orange">起/人</span><del class="orange_yj">'+infolist[m_i]['g_currprice']+'</del> <span class="orange_text">'+infolist[m_i]['g_name']+'</span></div><div style="overflow: hidden;"></div>';
							}
						}
