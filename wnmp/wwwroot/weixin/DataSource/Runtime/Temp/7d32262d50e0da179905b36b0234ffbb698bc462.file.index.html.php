<?php /* Smarty version Smarty-3.1.6, created on 2016-11-22 15:47:39
         compiled from "../DataSource/Tpl\User\index.html" */ ?>
<?php /*%%SmartyHeaderCode:15454581aa479cd2147-14098235%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '15454581aa479cd2147-14098235',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_581aa479d6a47',
  'variables' => 
  array (
    'user' => 0,
    'needpay' => 0,
...
<?php if ($_valid && !is_callable('content_581aa479d6a47')) {function content_581aa479d6a47($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('Comon/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
.wait_pay{position: absolute;right: 0;top: 0px;padding:0 0.25rem 0 0.25rem;height: 1.428571rem;line-height: 1.428571rem;font-size: 1rem;border: 1px solid #F75D00;text-align: center;border-radius: 6px;color: #F75D00;}*/
...
<?php }?></p>
	...
	<div class="weui_cells weui_cells_access userOrder">
	    ...
	    <div class="twoChoice" >
			...
			<a href="/User/order?page=2" class="lackInfo"><?php if ($_smarty_tpl->tpl_vars['needprefect']->value>0){?><span class="twoChoice_count lackInfo_count"><?php echo $_smarty_tpl->tpl_vars['needprefect']->value;?>
</span><?php }?><span class="twoChoice_ico lackInfo_icon"></span>
			未完善资料
			</a>
	    </div>
	</div>
	...
	<div class="weui_tabbar">
        ...
        <a href="/Run?p_type=5" class="weui_tabbar_item">
