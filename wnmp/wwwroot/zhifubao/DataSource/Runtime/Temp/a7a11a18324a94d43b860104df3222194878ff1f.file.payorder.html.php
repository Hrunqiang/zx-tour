<?php /* Smarty version Smarty-3.1.6, created on 2016-11-18 17:55:05
         compiled from "../DataSource/Tpl\PayResult\payorder.html" */ ?>
<?php /*%%SmartyHeaderCode:1340757a46bcdd3d5b0-97134256%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1340757a46bcdd3d5b0-97134256',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57a46bcdf1256',
  'variables' => 
  array (
    'price' => 0,
    'meal' => 0,
...
<?php if ($_valid && !is_callable('content_57a46bcdf1256')) {function content_57a46bcdf1256($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('Comon/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<div class="pay wrap">
    <div class="order_info weui_cells ">
        ...
        <div class="weui_msg"style="padding-bottom: 1.5rem;">
            ...
            <!--<h2 class="weui_msg_title"style="margin-bottom:0 ;">￥<?php echo intval($_smarty_tpl->tpl_vars['price']->value['payprice']);?>
</h2>--> 
            <h2 class="weui_msg_title"style="margin-bottom:0 ;">￥<?php echo $_smarty_tpl->tpl_vars['price']->value['payprice'];?>
</h2> 
        </div>
...
"  type="hidden"/>
    ...
    <div class="weui_cell_ft">
        ...
        <a href="/Enroll?m_id=<?php echo $_smarty_tpl->tpl_vars['price']->value['matchid'];?>
" class="pay_question">有问题，请重新选择套餐</a>
    </div>
    </form>
    <!--<div class="flexBox moreWay">
        <div class="flex_1"><a href="/Enroll?m_id=<?php echo $_smarty_tpl->tpl_vars['price']->value['matchid'];?>
">有疑问重新选择套餐</a></div>
...
var orderid = "";
var auth_code = "<?php echo $_smarty_tpl->tpl_vars['auth_code']->value;?>
";
var issenging = false;
// function agreement1(){
//     $("#agreementBox").show();
