<?php /* Smarty version Smarty-3.1.6, created on 2016-11-22 10:59:24
         compiled from "../DataSource/Tpl\User\perfect.html" */ ?>
<?php /*%%SmartyHeaderCode:185005811c7335b9e78-72899498%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '185005811c7335b9e78-72899498',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5811c7339cc45',
  'variables' => 
  array (
    'uid' => 0,
    'user' => 0,
...
<?php if ($_valid && !is_callable('content_5811c7339cc45')) {function content_5811c7339cc45($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('Comon/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<style>
	...
	.weui_cell_bd_color{color: #000000;}
	...
	.list_title span{height: 1.285714285714286rem;width: 0.2142857142857143rem;background: #ff2244;margin-right: 0.4285714285714286rem;float: left;margin-top: 0.2857142857142857rem;}
	.write_end{color: #FF2244;text-align: center;font-size: 1rem;padding-bottom: 1.5rem;}
	/*///////////////////////国外报名样式///////////////////////////////////////////*/
	...
	.preview_foot div:nth-child(2){background: #FF2244;}
	...
	/*///////////////////////////////////////预览样式end//*/
	.broad_input{display: inline-block;box-sizing: border-box;border: 1px solid #FF2244;border-radius: 5px;position: relative;padding: 0px!important;height: 2.142857142857143rem;width: 14.28571428571429rem;display: none;}
...
">
		...
		<!-- <div class="btn">
		    <input id="broad_next" type="button" value="下一步" class="weui_btn weui_btn_warn next_page">
		</div>
		<div class="write_end">就快填完了:)</div> -->
		<!--/////////////////////////////////////国外资料填写end//////////////////////////////////////-->
	</div>
	<div style="display: block;margin-top: 0.71428571428571rem" id="broad_page2">
		<!--/////////////////////////////////////国外资料继续填写//////////////////////////////////////-->
		...
		<div class="weui_cells weui_cells_form weui_cells_access">
			    <div class="weui_cell">
			        ...
			        <div class="weui_cell_bd weui_cell_primary weui_cell_bd_color">
			            <input class="weui_input" type="text"  placeholder="很重要，如果护照不在身边请之后补填" name="pass_code" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['pass_code'];?>
">
			        </div>
			    </div>
			    <div class="weui_cell">
...
">
			    ...
			    <div class="weui_cell">
			        ...
			        <div class="weui_cell_bd weui_cell_primary weui_cell_bd_color">
			            <input class="weui_input finish_data" type="text"  placeholder="格式为“小时:分钟:秒”" date-s="1949-10-1" name="wishfinish" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['wishfinish'];?>
">
			        </div>
			    </div>
		    </div>
...
">
		...
		<!--/////////////////////////////////////国外资料继续填写end//////////////////////////////////////-->
		<div class="btn">
	        <input id="broad_end"  type="button" value="提交" class="weui_btn weui_btn_warn">
	    </div>
	</div>
	</form>	
</div>
...
">
	    ...
	    <div class="btn">
	        <input id="china" type="button" value="提交" class="weui_btn weui_btn_warn">
	    </div>
	</form> 
</div>
