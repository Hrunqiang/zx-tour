<?php /* Smarty version Smarty-3.1.6, created on 2016-11-21 18:18:27
         compiled from "../DataSource/Tpl\User\userinfo.html" */ ?>
<?php /*%%SmartyHeaderCode:2010658294a016be608-46856677%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2010658294a016be608-46856677',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_58294a01998f0',
  'variables' => 
  array (
    'userstate' => 0,
    'info' => 0,
...
<?php if ($_valid && !is_callable('content_58294a01998f0')) {function content_58294a01998f0($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('Comon/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<style>
	...
	.msgChecked{color: #fb6165;border-bottom:0.17857142857143rem solid #fb6165;}
	...
	.weui_btn_warn{background-color: #fb6165}
</style>
<div class="infowrap">
	...
	<div class="weui_cells msg_title" style="margin-top: 0.71428571428571rem;height: 3.14285714285714rem;line-height: 3.14285714285714rem">
		<div style="margin-left: 1.07142857142857rem;height: 2.42857142857143rem;display: inline-block;text-align: left;font-size: 1.21428571428571rem;line-height: 2.42857142857143rem;margin-top: 0.53571428571429rem color: #fb6165;border: none;border-bottom:0.17857142857143rem solid #fb6165;color: #fb6165;">基本信息
		</div>
	</div>
		...
		<div class="weui_cells baseMsg">
			<div>
              ...
              <span class="broad_icon" style="position: absolute;background: url(/static/images/broad_input.png) no-repeat;background-size: 100%; width: 1.071428571428571rem;height: 1rem;right:7.5rem;top: 0.9285714285714286rem;display: none;"></span>
                <input class="weui_input userMsg userMsg_change inputStyle" type="text" name="broad_country" placeholder="请输入国籍" style="border: 1px solid #fb6165;height: 95%;width: 8.92857142857143rem;display: none;border-radius: 5px;box-sizing: border-box;padding-left: 1.642857142857143rem;" value="<?php echo $_smarty_tpl->tpl_vars['info']->value['broad_country'];?>
">
			</div>
		</div>
		<div class="weui_cells baseMsg">
...
">
	...
	<div class="weui_cells msg_title" style="margin-top: 0.71428571428571rem;height: 3.14285714285714rem;line-height: 3.14285714285714rem">
		<div style="margin-left: 1.07142857142857rem;height: 2.42857142857143rem;display: inline-block;text-align: left;font-size: 1.21428571428571rem;line-height: 2.42857142857143rem;margin-top: 0.53571428571429rem color: #fb6165;border: none;border-bottom:0.17857142857143rem solid #fb6165;color: #fb6165;">报名必填信息
		</div>
	</div>
...
">
			...
			<div class="weui_cells passportMsg">
				<div>
		            <p class="titleMsg"><span class="importantMsg">*</span>预期完赛时间</p><input class="weui_input userMsg userMsg_change inputStyle" type="text" placeholder="请注明此次赛事预期完赛成绩" date-s="1949-10-1" name="wishfinish"  value="<?php echo $_smarty_tpl->tpl_vars['info']->value['wishfinish'];?>
">
		        </div>
			</div>
		</div>
