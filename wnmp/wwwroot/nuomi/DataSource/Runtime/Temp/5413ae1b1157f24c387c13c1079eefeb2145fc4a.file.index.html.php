<?php /* Smarty version Smarty-3.1.6, created on 2016-11-21 17:27:38
         compiled from "../DataSource/Tpl\Run\index.html" */ ?>
<?php /*%%SmartyHeaderCode:119005832be0a0bc021-36819838%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '119005832be0a0bc021-36819838',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5832be0a6d320',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5832be0a6d320')) {function content_5832be0a6d320($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('Comon/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

<title>跑步赛事搜索</title>
<style>
.filter_section{padding:9px 0;color:#3f3f3f;background: #FFF;/*position: relative;*/font-size: 1rem;display: -webkit-box;-webkit-box-flex: 1;}
...
.filter_section>.flex_1>div{position: relative;-webkit-box-flex: 1;}
...
.filter_section .filter_cell .drop-down .drop_content_2 .sub_sf p.curr{color:#ff3175;background: #FFF;}
.filter_section .filter_cell .drop-down .drop_content_2 .hot_city{width: 9.285714285714286rem;height: 100%;display: none;}
.filter_section .filter_cell .drop-down .drop_content_2 .hot_city p.curr{color:#ff3175;background: #FFF;};
...
#page1{position: fixed;z-index: 1000;width: 100%;max-width: 768px;display: -webkit-box;}
...
.weui_btn_time{color: #FF3175;background: #FFFFFF;border: 1px solid #E0E0E0!important;}
...
.area_kind_curr{border: 1px solid #FF3175!important;border-radius: 0.3571428571428571rem;color: #FF3175!important;background: #FFFFFF;}
.area_btn{color: #FF3175;background: #FFFFFF;border: 1px solid #e0e0e0!important;}
.option_cell_area_curr{color: #ff3175;}
...
.reset_select span{height: 2.142857142857143rem;width: 7.142857142857143rem;text-align: center;background: #FF2244;font-size: 1rem;line-height: 2.142857142857143rem;}
/*//////////////////////////////////////////////////////热词样式/////////////////////////////////////////*/
...
<div class="wrap">
    ...
    <div id="page1" style="display: flex;display: -webkit-flex;display: -ms-flexbox;display: -webkit-box; background: #FFFFFF;border-bottom: 1px solid #EFEEF3;">
	            ...
	            <div class="drop-down">
	                <div class="drop_content" style="height: 100%;">
	                	<div class="time_biaoti">
	                		...
	                		<div style="width: 5.928571428571429rem;height: 0.1428571428571429rem;background: #FF2244;position: absolute;bottom: -0.2142857142857143rem;left: 2.928571428571429rem;"></div>
	                	</div>
	        ...
	        <div class="flex_1 filter_cell btn_hid">
	            ...
	            <div class="drop-down">
	                <div class="drop_content" style="font-size: 0.8571428571428571rem;background: #F8F8F8;height: 100%;">
	                	...
	                	<div class="more_btn">
	                		<input class="weui_btn" style="color: #FF3175;background: #FFFFFF;border:1px solid #e0e0e0;" type="button" name="" id="" value="完成" />
	                	</div>
	                </div>
	            </div>
	        </div>
