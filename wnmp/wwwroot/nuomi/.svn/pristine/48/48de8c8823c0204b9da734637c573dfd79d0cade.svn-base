...
class PicCut
{
     ...
     */
    function setSrcImg($src_img, $img_type=null,$referer="")
    {
...
//             echo("out url\r\n");
        ...
        $src = '';
        if(preg_match("/http:/i", $src_img)){
        	import("ORG.Mine.Http");
        	$Http	= new Http();
        	$src	= $Http->get($src_img,$referer);
        }
        if(function_exists("file_get_contents") && empty($src))
        {
    ...
    function createImg($a, $b=null)
    {
        ...
        if(1 == $num)
        {
            ...
            if($r < 1)
            {
                echo ("Image scaling should not be less than 1\r\n");
                return;
            }
            $this->img_scale = $r;
        ...
        if(2 == $num)
        {
            ...
            if(0 == $w)
            {
                echo("The target width of 0\r\n");
                return;
            }
            if(0 == $h)
            {
                echo("The target must be 0\r\n");
                return;
            }
    ...
    function _createMask()
    {
        if($this->mask_word)
        {
            ...
            if($this->_isFull())
            {
                echo("Watermark text is too large\r\n");
                return;
            }
            else
            {
    ...
    function _loadMaskImg()
    {
        ...
        {
            echo ("The watermark image is empty\r\n");
            return;
        }
    ...
    function _setNewImgSize($img_w, $img_h=null)
    {
        ...
        if(2 == $num)
        {
            ...
            {
                echo("Photo frame is too big, more than the width of the image\r\n");
                return;
            }
...
//                             $this->setRectangleCut($fill_h, $fill_h);
                            ...
                            $this->copy_w = $this->src_w*$fill_h/$fill_w;
//                             $this->copy_w = $this->src_h;
    ...
    function _checkMaskValid()
    {
        ...
        {
            echo("The watermark image size is greater than the original, please reduce watermark\r\n");
            return;
        }
    }
    ...
    {
        $type_list = array("1"=>"gif","2"=>"jpg","3"=>"png","6"=>"bmp","15"=>"wbmp");
        ...
        {
        	return "jpg";
//             echo("File does not exist, cannot achieve the file type!");
//             return;
        }
    }
