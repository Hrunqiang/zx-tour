 ...
 * 报名
 * */
class UserFeedbackAction extends Action {
	...
	public function index(){
		$table_cfg	= array(
				"tables"=>array(	
						'zx_tb_feedback' =>array(
								"join" =>"uid",
								"iszb" =>true,
								"field"=>array(
										'phone'	=>array('ismain'=>true,'title'=>'手机号','isabm'=>false,'islist'=>true,'type'=>'text'),
										'type'	=>array('title'=>'反馈类型','isabm'=>true,'islist'=>true,'type'=>'text'),
										'content'	=>array('title'=>'反馈内容','isabm'=>true,'islist'=>true,'type'=>'text'),
										'img'	=>array('title'=>'反馈图片','isabm'=>true,'islist'=>true,'type'=>'img'),
										'ctime'	=>array('title'=>'最后更改时间','isabm'=>false,'islist'=>true,'type'=>'text'),
								)
						),
