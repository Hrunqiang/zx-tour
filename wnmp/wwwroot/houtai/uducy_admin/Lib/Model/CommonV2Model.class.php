<?php
class CommonV2Model extends CoreModel{
	protected $connection = 'DB_CONFIG1_zx';
	public function getList($table_obj,$field="*",$offset,$length,$where,$order=''){
		...
		$sql	= "select $field from $table_str $where $order limit $offset,$length";
