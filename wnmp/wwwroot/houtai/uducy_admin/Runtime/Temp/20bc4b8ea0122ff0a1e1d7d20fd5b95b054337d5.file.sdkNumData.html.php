<?php /* Smarty version Smarty-3.1.6, created on 2016-11-14 10:40:16
         compiled from "../uducy_admin/Tpl\common\sdkNumData.html" */ ?>
<?php /*%%SmartyHeaderCode:30253582924107c0e30-16058489%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '30253582924107c0e30-16058489',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_582924109d422',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_582924109d422')) {function content_582924109d422($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\wnmp\\wwwroot\\houtai\\lib\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
?><?php echo $_smarty_tpl->getSubTemplate ('Login/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

<style>
.searchtxt{width:45px;}
...
"><?php echo $_smarty_tpl->tpl_vars['li']->value[$_smarty_tpl->tpl_vars['cfgk']->value];?>
                    			...
                    			<?php }elseif($_smarty_tpl->tpl_vars['cfgi']->value['type']=='img'){?>
                                    <?php  $_smarty_tpl->tpl_vars['imgs'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['imgs']->_loop = false;
 $_smarty_tpl->tpl_vars['imgkey'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['li']->value[$_smarty_tpl->tpl_vars['cfgk']->value]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['imgs']->key => $_smarty_tpl->tpl_vars['imgs']->value){
$_smarty_tpl->tpl_vars['imgs']->_loop = true;
 $_smarty_tpl->tpl_vars['imgkey']->value = $_smarty_tpl->tpl_vars['imgs']->key;
?>
